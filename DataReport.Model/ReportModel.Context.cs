...
namespace DataReport.Model
{
    ...
    public partial class SingletonEntities : DbContext, IReportContext
    {
        public SingletonEntities()
            : base("name=SingletonEntities")
        {
        }
        ...
        public virtual IDbSet<singleton> Singletons { get; set; }
    }
}
