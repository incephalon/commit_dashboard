...
"use strict";
angular.module("myApp.localization", []).factory("localize", ["$http", "$rootScope", "$window",
    function ($http, $rootScope, $window) {
        ...
        return localize = {
            ...
            buildUrl: function () {
                return localize.language || (localize.language = ($window.navigator.userLanguage || $window.navigator.language).toLowerCase(), localize.language = localize.language.split("-")[0]), "/app/i18n/resources-locale_" + localize.language + ".js"
            },
