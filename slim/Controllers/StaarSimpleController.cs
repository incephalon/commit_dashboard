...
namespace slim.Controllers
{
    public class StaarSimpleController : ApiController
    {
        ...
        public const string connectionString = "Server=tcp:uld67t7jyl.database.windows.net,1433;Database=commit_staar_full;User ID=robert@uld67t7jyl;Password=Commit!1;Trusted_Connection=False;Encrypt=True;Connection Timeout=30;";
        ...
        public List<Dictionary<string, string>> Get()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand command = new SqlCommand("SELECT * FROM dbo.district_data WHERE [DISTRICT]= '''1'", connection);
